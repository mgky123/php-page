...
$base->content = '
		...
		<form action="./reserveg.php" method="post">
			<table id="new">
				<tr>
					<td colspan="2"  style="font-size:14px; padding:0 0 8px 0;">예약할 도서를 불러와 확인후 예약합니다.</td>
				</tr>
				<tr>
					<td><input type="text" name="searchNum" size="10" placeholder="예약할 도서번호" style="width:150px; border:1px solid black;"></td>
					<td><input type="submit" name="btn" value="불러오기" style="width:120px; height:30px;"></td>
				</tr>
				<tr>
					<td><input type="text" name="searchTitle" size="10" placeholder="예약할 도서명" style="width:150px; border:1px solid black;"></td>
					<td><input type="submit" name="btn" value="불러오기" style="width:120px; height:30px;"></td>
				</tr>
			</table>
		</form>
		<form action="./reserveb.php" method="post">
			<table id="new">
				...
				<tr>
					<td colspan="2"><input type="submit" value="해당도서 예약" style="width:150px; height:30px; margin:10px 0 0 90px;"></td>
				</tr>
			</table>
		</form>
		';
